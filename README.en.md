...
| 💊 Witch | Village Faction | Has one healing potion and one poison potion |
...
1. **Start Game**: Click "Start Game" to create a 9-player game (1 human + 8 AI)
...
3. **Night Phase**:
   ...
   - Witch decides whether to use healing or poison potion
4. **Day Phase**:
